...
void cOBB::Setup(LPD3DXMESH pMesh)
{
	D3DXVECTOR3 m_vMin(0, 0, 0), m_vMax(0, 0, 0);
...
void cOBB::DebugRender( D3DCOLOR c )
{
	if (KEYMANAGER->isToggleKey('P'))
	{
		...
		//LPD3DXMESH pSphere;
		//D3DXCreateSphere(g_pD3DDevice, 96, 30, 30, &pSphere, NULL);
		...
		//g_pD3DDevice->SetRenderState(D3DRS_FILLMODE, false);
